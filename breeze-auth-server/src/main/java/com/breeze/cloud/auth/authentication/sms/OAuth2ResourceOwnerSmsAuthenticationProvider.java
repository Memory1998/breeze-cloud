...
public class OAuth2ResourceOwnerSmsAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (!registeredClient.getAuthorizationGrantTypes().contains(CustomAuthorizationGrantType.SMS_CODE)) {
    ...
    private Authentication getUsernameSmsAuthentication(OAuth2ResourceOwnerSmsAuthenticationToken resourceOwnerSmsAuthentication) {
        ...
        SmsAuthenticationToken smsAuthenticationToken = new SmsAuthenticationToken(username, code);
