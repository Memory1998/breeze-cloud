...
INSERT INTO `config_info` VALUES (163, 'breeze-sentinel-dev.yml', 'DEFAULT_GROUP', 'spring:\n  cloud:\n    sentinel:\n      transport:\n        dashboard: ${SENTINEL_HOST:breeze-sentinel}:${SENTINEL_PORT:8081}', '0d9760bf58e526af3453d1feaa77d768', '2023-05-20 07:18:09', '2023-05-20 07:18:46', 'nacos', '172.18.0.1', '', 'dev', '', '', '', 'yaml', '', '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 85 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '多租户改造' ROW_FORMAT = Dynamic;
