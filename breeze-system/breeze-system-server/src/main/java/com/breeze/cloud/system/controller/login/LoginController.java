...
import com.breeze.cloud.security.auth.AuthAuthenticationToken;
import com.breeze.cloud.security.email.EmailCodeAuthenticationToken;
...
import com.breeze.cloud.security.sms.SmsAuthenticationToken;
import com.breeze.cloud.security.utils.WxHttpInterfaceUtils;
import com.breeze.cloud.security.wx.WxCodeAuthenticationToken;
import com.breeze.cloud.security.wxphone.WxPhoneAuthenticationToken;
...
public class LoginController {
    ...
    public Result<Map<String, Object>> wxGetPhone(@RequestBody WxLoginParam wxLoginParam) {
        ...
        String phoneNumber = WxHttpInterfaceUtils.getPhoneNumber(wxLoginParam.getCode(), accessToken);
