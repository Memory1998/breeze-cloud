...
import static com.breeze.cloud.core.enums.ResultCode.*;
...
public class GlobalExceptionHandler {
    ...
    public Result<?> retryableException(RetryableException ex) {
        log.error("RetryableException feign超时：", ex);
        return Result.fail(TIME_OUT_EXCEPTION);
    }
